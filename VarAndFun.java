...
public class VarAndFun {
    ...
    public static int getAPositiveInteger(){
        ...
        return n;  //n = getAPositiveInteger
    }
    //in n số tự nhiên tính từ 1
    public static void printIntegerList(int n){
        //đứa nào scanf là thằng ngáo,n đa óc value
        System.out.println("the list of n: " + n + " first integer");
        for (int i = 1; i <= n; i++) {
            System.out.printf("%d\n" , i);
    ...
    //Hiện tượng 1 class bát kì chứa nhiều hàm trùng tên nhưng khác phần tham số
    //mà phải khác trên datatype chứ không phải khác tên biến
